...
Class Paypal extends Aj {
    public function generate_link() {
        ...
        $ReturnUrl = self::Config()->uri . '/aj/paypal/payment_success?userid=' . auth()->id . '&mode=' . $mode . '&price=' . $price . '&product=' . urlencode($product);
        $CancelUrl = self::Config()->uri . '/aj/paypal/payment_cenceled?userid=' . auth()->id . '&mode=' . $mode . '&price=' . $price . '&product=' . urlencode($product);
        try {
