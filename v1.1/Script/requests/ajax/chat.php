...
//            //}
    ...
    function get_stickers() {
        ...
        $stickers_html = '';
        $stickers      = $db->objectBuilder()->orderBy('id', 'desc')->get('stickers', null, array(
            'id',
            'file'
        ));
        $i             = 0;
        ...
        if ($limit_stickers > 0) {
            ...
            if (self::ActiveUser()->balance >= $config->not_pro_chat_stickers_credit) {
                $stickers_html .= '<div class="dt_stk_buy_btn"><a href="' . $config->uri . '/pro" data-ajax="/pro" class="btn btn-flat waves-effect prem">' . __('Get premium') . '</a>';
