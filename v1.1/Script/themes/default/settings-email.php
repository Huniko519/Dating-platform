...
<!--                <li class="tab col s3"><a class="active" href="javascript:void(0);" data-ajax="/settings-email" target="_self">--><?php //echo __( 'Emails' );?><!--</a></li>-->
        ...
        <form method="post" action="/profile/save_email_setting" class="col s12 m6">
            ...
            <div class="row">
                ...
                <div class="input-field col s12">
                    <p class="switch">
                        <label>
                            <?php echo __( 'Email me when someone like your profile' );?>
