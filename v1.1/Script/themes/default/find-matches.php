							...
							<div class="collapsible-body filter_tabs_parent row">
								...
								<div id="basic" class="col s12 active search_filters">
									<form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
										...
										<div class="btn_wrapper valign-wrapper">
											<button class="btn waves-effect btn_glossy btn-flat btn-large waves-light" type="button" id="btn_search_basic"><?php echo __('Search');?></button>
										</div>
									</form>
								</div>
								<div id="looks" class="col s12 search_filters" style="display: none;">
									<form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
												...
												<?php
													...
													if (isset($body) && !empty($body)) {
														foreach ($body as $key => $val) {
															echo '<p class="col s6 m3"><label><input type="checkbox" class="_body filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
										...
										<div class="btn_wrapper valign-wrapper">
											<button class="btn waves-effect btn_glossy btn-flat btn-large waves-light" id="btn_search_looks" type="button"><?php echo __('Search');?></button>
										</div>
									</form>
								</div>
...
<!--                                                        <option value="english" data-txt="English">English</option><option value="arabic" data-txt="Arabic">Arabic</option><option value="dutch" data-txt="Dutch">Dutch</option><option value="french" data-txt="French">French</option><option value="german" data-txt="German">German</option><option value="italian" data-txt="Italian">Italian</option><option value="portuguese" data-txt="Portuguese">Portuguese</option><option value="russian" data-txt="Russian">Russian</option><option value="spanish" data-txt="Spanish">Spanish</option><option value="turkish" data-txt="Turkish">Turkish</option>-->
												...
												<?php
													...
													if (isset($ethnicity) && !empty($ethnicity)) {
														foreach ($ethnicity as $key => $val) {
															echo '<p class="col s6"><label><input type="checkbox" class="_ethnicity filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
												...
												<?php
													...
													if (isset($religion) && !empty($religion)) {
														foreach ($religion as $key => $val) {
															echo '<p class="col s6"><label><input type="checkbox" class="_religion filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
										...
										<div class="btn_wrapper valign-wrapper">
											<button class="btn waves-effect btn_glossy btn-flat btn-large waves-light" id="btn_search_background" type="button"><?php echo __('Search');?></button>
										</div>
									</form>
								</div>
								<div id="lifestyle" class="col s12 search_filters" style="display: none;">
									<form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
												...
												<?php
													...
													if (isset($relationship) && !empty($relationship)) {
														foreach ($relationship as $key => $val) {
															echo '<p class="col s6 m12"><label><input type="checkbox" name="relationship" class="_relationship filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
												...
												<?php
													...
													if (isset($smoke) && !empty($smoke)) {
														foreach ($smoke as $key => $val) {
															echo '<p class="col s6 m12"><label><input type="checkbox" name="smoke" class="_smoke filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
												...
												<?php
													...
													if (isset($drink) && !empty($drink)) {
														foreach ($drink as $key => $val) {
															echo '<p class="col s6 m12"><label><input type="checkbox" name="drink" class="_drink filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
										...
										<div class="btn_wrapper valign-wrapper">
											<button class="btn waves-effect btn_glossy btn-flat btn-large waves-light" id="btn_search_lifestyle" type="button"><?php echo __('Search');?></button>
										</div>
									</form>
								</div>
								<div id="tab_more" class="col s12 search_filters" style="display: none;">
									<form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
												...
												<?php
													...
													if (isset($education) && !empty($education)) {
														foreach ($education as $key => $val) {
															echo '<p class="col s6"><label><input type="checkbox" name="education" class="_education filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
												...
												<?php
													...
													if (isset($pets) && !empty($pets)) {
														foreach ($pets as $key => $val) {
															echo '<p class="col s6 m12"><label><input type="checkbox" name="pets" class="_pets filled-in" value="' . $key . '" data-txt="' . __($val) . '"/><span>' . __($val) . '</span></label></p>';
														}
													}
												?>
											</div>
										...
										<div class="btn_wrapper valign-wrapper">
											<button class="btn waves-effect btn_glossy btn-flat btn-large waves-light" id="btn_search_more" type="button"><?php echo __('Search');?></button>
										</div>
									</form>
								</div>
							</div>
