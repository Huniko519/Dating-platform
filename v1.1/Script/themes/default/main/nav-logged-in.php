		...
		<nav role="navigation" id="nav-logged-in">
            <div class="nav-wrapper container">
                ...
                <div class="left header_logo">
                    <a id="logo-container" href="<?php echo $site_url;?>/<?php if( $profile->verified == 1 ){?>find-matches<?php }?>" class="brand-logo"><img src="<?php echo $theme_url;?>assets/img/logo.png" /></a>
                </div>
