...
<div id="gify_box" class="hide bottom-sheet">
    <div class="modal-content">
        <h5>
            ...
            <button type="button" id="reload_gifs" class="btn-floating btn-large waves-effect waves-light green" style="width: 35px;height: 35px;margin: 0 auto;">
