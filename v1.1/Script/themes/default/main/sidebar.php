...
<div class="dt_sections">
	...
	?>
		<div class="dt_home_pro_usr">
			<h4 class="bold"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="currentColor" d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z" /></svg> <?php echo __( 'Premium Users' );?></h4>
			<div>
				<div class="pro_usrs_container">
					...
					<?php
						if( $pro_users ){
							...
							if(isUserInBlockList(strtolower($pro_user->username)) === false) {
					?>
						<div class="pro_usr">
	...
	<?php } else { ?>
		<div class="dt_home_pro_usr">
			<h4 class="bold"><div><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="currentColor" d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z" /></svg></div> <?php echo __( 'Premium Users' );?></h4>
			<div class="pro_usrs_container">
				<?php if( $profile->is_pro == 0){?>
					<div class="pro_usr add_me">
						<a href="<?php echo $site_url;?>/pro" data-ajax="/pro" class="pulse">
