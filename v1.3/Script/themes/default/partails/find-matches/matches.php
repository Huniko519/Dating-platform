            ...
            <div class="mtc_usrd_slider">
                ...
                <?php if( $mode == 'hot' ){?>
                    <div class="mtc_usrd_actions">
                        ...
                        <button href="javascript:void(0);" data-userid="<?php echo $matche->id;?>" id="matches_dislike_btn" data-ajax-post="/useractions/not" data-source="hot" data-ajax-params="userid=<?php echo $matche->id;?>&username=<?php echo $matche->username;?>&source=find-matches" data-ajax-callback="callback_not" class="btn waves-effect dislike hot">
